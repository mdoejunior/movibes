            ...
            <div className='text-white w-full bg-light-white rounded-3xl overflow-hidden shadow-lg mt-8'>
                <div className='flex items-center m-3'>
                    <label htmlFor='checkbox-1' className='ml-2 relative'>Action
                        ...
                        <FontAwesomeIcon icon={faCheck}
                                         className='text-8xl h-5 text-opacity-0 check-1 rounded w-5 text-black bg-hover-color absolute left-44 top-2'/>
                    </label>
                </div>
                <Divider/>
                <div className='flex items-center m-3'>
                ...
                <div className='flex items-center m-3'>
                    <label htmlFor='checkbox-3' className='ml-2 relative'>Animated
                        ...
                        <FontAwesomeIcon icon={faCheck}
                                         className='text-8xl text-opacity-0 check-1 h-5 rounded w-5 text-black bg-hover-color absolute left-44 top-2'/>
                    </label>
                </div>
                <Divider/>
                <div className='flex items-center m-3'>
                ...
                <div className='flex items-center m-3'>
                    <label htmlFor='checkbox-5' className='ml-2 relative'>Crime
                        ...
                        <FontAwesomeIcon icon={faCheck}
                                         className='text-8xl h-5 rounded text-opacity-0 check-1 w-5 text-black bg-hover-color absolute left-44 top-2'/>
                    </label>
                </div>
                <Divider/>
                <div className='flex items-center m-3'>
                    <label htmlFor='checkbox-6' className='ml-2 relative'>Fantasy
                        ...
                        <FontAwesomeIcon icon={faCheck}
                                         className='text-8xl h-5 rounded w-5 text-opacity-0 check-1 text-black bg-hover-color absolute left-44 top-2'/>
                    </label>
                </div>
                <Divider/>
...
const Divider = () => <hr
    className="ml-4 mr-9 bg-gray-600 dark:gray-600 border border-gray-600  dark:gray-600 rounded-full"/>;
